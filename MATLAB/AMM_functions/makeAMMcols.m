function [aout] = makeAMMcols(a,vecin,nbaseline,namm)
    ...
    % Note: specify nbaseline or namm only, based on whether the baseline annot is before (to the left of) the AMM annot -- if baseline annot is before the AMM annot, leave namm as []; if AMM annot is before the baseline, leave nbaseline as [].
