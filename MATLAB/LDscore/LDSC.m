...
%LDSC (MATLAB implementation of LD score regression)
%
...
%   default: 0->shuffle
%   NoiseVar: LD score regression fixed intercept
%
%   OUTPUT ARGUMENTS:
...
LDSCout(1).h2est=mean(h21_jk,2);
LDSCout(1).h2err=std(h21_jk,[],2)*sqrt(no_blocks+1);
